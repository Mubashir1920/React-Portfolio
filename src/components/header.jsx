        ...
        <div className='container mx-auto'>
            ...
            {isMobileMenuOpen &&
                ...
                >
                    ...
                    <Link onClick={() => setIsMobileMenuOpen(prevState => !prevState)} to='/contact' className="font-bold relative text-md w-fit block after:block after:content-[''] after:absolute after:h-[3px] after:bg-white after:w-full after:scale-x-0 after:hover:scale-x-100 after:transition after:duration-300 after:origin-left ">Contact</Link>
