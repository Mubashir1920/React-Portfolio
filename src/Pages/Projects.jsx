    ...
    <div className='container mx-auto' >
      <div className="flex flex-wrap  pt-20 justify-center">
        {projectType.map(item => (
          <a key={item.id} onClick={() => ActiveTab(item)} href="#_" className={`relative mx-3 mb-5 ${selectedTab === item ? 'bg-purple-800' : ''}  px-6 py-3 font-bold text-white rounded-lg group`}>
